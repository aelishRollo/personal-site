...
(function() {
	...
	var skins = [
		...
		{ id: 'psychedelic-scrapbook', name: 'Psychedelic Scrapbook', scheme: 'light', css: 'assets/css/skins/psychedelic-scrapbook.css?v=psychedelic-scrapbook-original-1' },
		...
		{ id: 'crystal-prism', name: 'Crystal Prism', scheme: 'dark', css: 'assets/css/skins/crystal-prism.css?v=crystal-prism-1' }
	];
	var skinById = {};
	var activeId = '';
	var persistedId = '';
